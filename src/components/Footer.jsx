...
const Footer = () => {
  return (
    ...
    <div className='flex items-center justify-center '>
            <h1 className='  text-orange-500 text-4xl font-semibold cursor-pointer p-8'> <span className='text-white'>4K</span>  Iptv <span className='text-white'>Deutschland</span> </h1>
    </div>
    <div className='flex items-center justify-center'>
